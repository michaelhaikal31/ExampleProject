...
public class DeviceList extends ListActivity {
    ...
    protected void onActivityResult(int reqCode, int resultCode, Intent intent) {
        ...
        System.out.println("asd activity result");
        switch (reqCode) {
            case REQUEST_ENABLE_BT:
                System.out.println("asd enable bt");
                        ...
                        if (btDeviceList.size() > 0) {
                            for (BluetoothDevice device : btDeviceList) {
                                if (btDeviceList.contains(device) == false) {
                                    ...
                                    System.out.println("asd device added");
                ...
                try {
                    ...
                    if (btDevices == null) {
                        ...
                        btDevices = new ArrayAdapter<BluetoothDevice>(
                                ...
                                getApplicationContext(),android.R.layout.simple_expandable_list_item_2);
